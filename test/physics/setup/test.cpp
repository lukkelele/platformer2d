...
namespace platformer2d::test {
	...
	static constexpr std::uint32_t RectangleIndices[] = {
		0, 1, 2,
		2, 3, 0};

	static b2WorldId WorldID;

	static bool bMetrics = false;
	static bool bIdStackTool = false;
	static bool bStyleEditor = false;
	static bool bBlendFunc = false;
	static bool bShowDrawStats = false;
